 ...
 */
final class Version20260325082010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE statistique_logement (id INT AUTO_INCREMENT NOT NULL, construction DOUBLE PRECISION NOT NULL, nombre_logement INT NOT NULL, logements_mis_en_location INT DEFAULT NULL, taux_pauvrete DOUBLE PRECISION DEFAULT NULL, departement_code VARCHAR(3) DEFAULT NULL, INDEX IDX_57E380456A333750 (departement_code), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
